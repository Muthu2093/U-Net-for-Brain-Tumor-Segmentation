...
def load_dataset(path):
    train_t2 = np.zeros([176,256,256,1])
    train_t1c = np.zeros([176,256,256,1])
    train_t1 = np.zeros([176,256,256,1])
    train_flair = np.zeros([176,256,256,1])
    train_ot = np.zeros([176,256,256,1])
